<?php
$Research_FGDS = getarr('caop_research', "research_type='2'");
//debug($AllResearch);

$Research_FGDS = array_orderby($Research_FGDS, 'research_status', SORT_ASC, 'research_unix', SORT_ASC);
// 'patient_order', SORT_ASC
//, 'research_status', SORT_ASC
//

if ( count($Research_FGDS) > 0 )
{
	...
	foreach ($Research_FGDS as $Patient) {
//		debug($Patient);
