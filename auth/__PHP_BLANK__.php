...
$BLANK_SCRIPT = ''; // название страницы
$BLANK_SCRIPT_PRINT = $BLANK_SCRIPT . 'Print'; // название страницы для печати
$BLANK_BUTTON_ADD = ''; // название кнопки добавления
$BLANK_TABLE_LIST = ; // таблица со списком
$BLANK_TABLE_FIELD_ID = ''; // id столбца индекса
$BLANK_TABLE_FIELD_PATID = ''; // id столбца пациента
$BLANK_TABLE_FIELD_SORT = ''; // id столбца с вводимой датой
$BLANK_TABLE_FIELD_UPDATE = ''; // id столбца с unix-обновлением
$BLANK_LIST_TITLE = ''; // название спойлера
$BLANK_LIST_DESC = ''; // название спойлера итема
$BLANK_LIST_EDIT = ''; // название спойлера редактирования изначального
$BLANK_LIST_EDIT_DAILY = ''; // название спойлера редактирования постнажатия
$BLANK_LIST_CREATURE = ''; // название спойлера даты составления
$BLANK_LIST_EMPTY = ''; // сообщение - нет итемов
$BLANK_LIST_FULLEMPTY = ''; // сообщение - нет вообще итемов
$BLANK_LIST_NOEXIST = ''; // сообщение - не существует итем
$BLANK_LIST_NOCHOOSE = ''; // сообщение - не существует итем, если в урле прописано
$BLANK_LIST_REMOVE_CONFIRM = ''; // подтверждение удаления
$BLANK_PREFIX_MAIN = 'dl'; // префикс главного спойлера
$BLANK_PREFIX_ITEM = 'daily'; // префикс спойлеров элементов
$BLANK_DG_MKB = ''; // поле МКБ
$BLANK_DG_TEXT = ''; // поле текст
$BLANK_ARRAY_INIT_VALUES = array();
$BLANK_ADDON_INFO = array(
	'НАЗВАНИЕ ПОЛЯ' => array(
		'field' => 'ИДЕНТ ПОЛЯ, КОТОРОЕ НУЖНО ОТОБРАЗИТЬ',
		'foreign_arrid' => 'ЕСЛИ ОНО СВЯЗАНО С ТАБЛИЦЕЙ - УКАЗАТЬ МАССИВ C ID-данными',
		'foreign_title_field' => 'И УКАЗАТЬ ПОЛЕ'
	),
	'НАЗВАНИЕ ПОЛЯ 2' => array(
		'field' => 'ЕСЛИ ПОЛЕ В САМОЙ ТАБЛИЦЕ',
	)
);
...
//				debug($routeSheet);
		...
		if ( $RequestParamsData[1] == "add" )
		{
			...
			if ( $triggerEmpty )
			{
				...
				$BLANK_ARRAY_INIT_VALUES['daily_date_create'] = date("d.m.Y", time());
