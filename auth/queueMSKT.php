<?php
$Research_MSKT = getarr('caop_research', "research_type='4'");
//debug($AllResearch);

$Research_MSKT = array_orderby($Research_MSKT, 'research_status', SORT_ASC, 'research_unix', SORT_ASC);
// 'patient_order', SORT_ASC
//, 'research_status', SORT_ASC
//

if ( count($Research_MSKT) > 0 )
{
	...
	foreach ($Research_MSKT as $Patient) {
//		debug($Patient);
