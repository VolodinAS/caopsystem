...
$queryVisits = "SELECT * FROM {$CAOP_JOURNAL} WHERE journal_day IN (SELECT day_id FROM {$CAOP_DAYS} WHERE 1 ORDER BY day_id DESC) GROUP BY journal_patid ORDER BY journal_id DESC";
//	debug($queryVisits);
