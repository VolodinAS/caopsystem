<?php
$LpuBlankName = $LPU_DOCTOR['lpu_blank_name'];
$LpuAddress = $LPU_DOCTOR['lpu_lpu_address'];
?>
<div class="header">
	<div class="gbuz boldy"><?=$LpuBlankName;?></div>
	<div class="address boldy"><?=$LpuAddress;?></div>
	<div class="listheader boldy">РЕЕСТР ДЛЯ СТАТОТДЕЛА</div>
</div>
<div>
	<div>
		...
		<table class="minitable" border="1" cellpadding="2">
			<thead>
				<tr>
					...
					<th class="boldy tablehead">Исход&nbsp;случая</th>
				</tr>
			</thead>
			<tbody>
		<?php
