                ...
                <tr>
                    ...
                    <td>
                        <table class="tbc" border="1">
                            <tr>
								<?php
								echo strInTD(trim($BlankPrint['dir_benefit_code']))
								?>
                            </tr>
                        </table>
                    </td>
    ...
    <tr>
        ...
        <td>
            <table width="100%" class="tbc" border="1" cellpadding="10">
                <tr>
                    <td>
						<?=$BlankPrint['dir_job_name'];?>
                    </td>
                </tr>
                <tr>
                    <td>
						<?=$BlankPrint['dir_job_duty'];?>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        ...
        <td>
            <table class="tbc size-14pt boldy" border="1" cellpadding="7">
                <tr>
					<?php
					echo strInTD($BlankPrint['dir_mkb_code'])
					?>
                </tr>
            </table>
        </td>
...
<table width="100%" class="tbc size-12pt" border="1" cellpadding="5">
    <tr>
        <td><b>9. Диагноз:</b> <?=$BlankPrint['dir_mkb_text'];?></td>
    </tr>
</table>
<br><br>
<?php
$HeadmanData = $DoctorsListId['id' . $LPU_DOCTOR['lpu_lpu_ceo_id']];
?>
<table width="100%" class="tbc size-12pt">
    <tr>
        ...
        <td align="center"><?=docNameShort($DoctorData, 'famimot');?></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    ...
    <tr>
        ...
        <td align="center"><b>Заведущий <?=$LPU_DOCTOR['lpu_lpu'];?></b></td>
        <td align="center"><?=docNameShort($HeadmanData, 'famimot');?></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    ...
    <tr>
        ...
        <td align="center"><b>Заведущий <?=$LPU_DOCTOR['lpu_division'];?></b></td>
        <td align="center"><?=$LPU_DOCTOR['lpu_ceo'];?></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    ...
    <tr>
        ...
        <td class="size-16pt" align="center">
			<?php
			echo processRussianDateReverse($BlankPrint['dir_date'], '.', ' ') . ' г.'
			?>
        </td>
        <td>&nbsp;</td>
    </tr>
