...
$BLANK_FIELD_ID = 'morph_id'; // название поля индекса
$BLANK_FIELD_PATID = 'morph_patient_id'; // название поля id пациента
$BLANK_FIELD_DOCID = 'morph_doctor_id'; // название поля id врача
$BLANK_HTML = 'morphology'; // название скрипта HTML
