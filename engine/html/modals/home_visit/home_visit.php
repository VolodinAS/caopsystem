<?php
$ModalSettings = array(
	'modal_name' => 'home_visit',
	'modal_header' => 'Просмотр процесса обработки вызова',
	...
	'modal_submodal' => false  /*ОКНО ОТКРЫВАЕТСЯ ПОВЕРХ ДРУГОГО ОКНА, добавить -submodal в "modal_name"*/
);
	...
	<div class="modal-dialog modal-dialog-centered modal-<?= $ModalSettings['modal_width']; ?>" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer" id="<?= $ModalSettings['modal_name']; ?>_footer">
                <button type="button" class="btn btn-info" onclick="" id="btn_home_visit_refresh">Обновить</button>
				<?= $modal_cancel_button; ?>
			</div>
		</div>
	</div>
