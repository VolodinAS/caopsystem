...
$ModalSettings = array(
	'modal_name' => 'myemodal',
	'modal_header' => 'Редактирование записи',
	'modal_width' => CODE_XL, /*РАЗМЕР*/
	...
	'modal_submodal' => true  /*ОКНО ОТКРЫВАЕТСЯ ПОВЕРХ ДРУГОГО ОКНА, добавить -submodal в "modal_name"*/
);
	...
	<div class="modal-dialog modal-dialog-centered modal-<?= $ModalSettings['modal_width']; ?>" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer" id="<?= $ModalSettings['modal_name']; ?>_footer">
                <button type="button" class="btn btn-info mysqleditor-modal-form" id="mf_button_refresh">Обновить</button>
				<?= $modal_cancel_button; ?>
			</div>
		</div>
	</div>
