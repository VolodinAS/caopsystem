<?php
$ModalSettings = array(
	'modal_name' => 'viewRouteSheet',
	'modal_header' => 'Просмотр списка маршрутных листов',
	'modal_width' => 'xl',
	'modal_cancel_button' => true,
	'modal_loader_default' => true
);
...
?>
<div class="modal fade" id="<?= $ModalSettings['modal_name']; ?>" tabindex="-1" role="dialog" aria-labelledby="<?= $ModalSettings['modal_name']; ?>" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-<?= $ModalSettings['modal_width'];?>" role="document">
        <div class="modal-content">
            <div class="modal-header" id="<?= $ModalSettings['modal_name']; ?>_header">
                <h5 class="modal-title" id="<?= $ModalSettings['modal_name']; ?>_header_string"><?= $ModalSettings['modal_header']; ?></h5>
