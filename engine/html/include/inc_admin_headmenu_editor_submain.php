<div class="css-table-row">
	...
	<div class="<?= $activeColor; ?>" <?=super_bootstrap_tooltip('Чьим подменю является');?>>
		<input class="form-control form-control-sm mysqleditor"
		       type="text"
		       value="<?= $subMenuItem['headmenu_subid']; ?>"
		       data-action="edit"
		       data-table="<?= CAOP_HEADMENU; ?>"
		       data-assoc="0"
		       data-fieldid="headmenu_id"
	...
	<div class="<?= $activeColor; ?>" <?=super_bootstrap_tooltip('Есть подменю? (1/0)');?>>
		<input class="form-control form-control-sm mysqleditor"
		       type="text"
		       value="<?= $subMenuItem['headmenu_hassubmenu']; ?>"
		       data-action="edit"
		       data-table="<?= CAOP_HEADMENU; ?>"
		       data-assoc="0"
		       data-fieldid="headmenu_id"
	...
	<div class="<?= $activeColor; ?>" <?=super_bootstrap_tooltip('Ссылка');?>>
		<input class="form-control form-control-sm mysqleditor"
		       type="text"
		       value="<?= $subMenuItem['headmenu_link']; ?>"
		       data-action="edit"
		       data-table="<?= CAOP_HEADMENU; ?>"
		       data-assoc="0"
		       data-fieldid="headmenu_id"
	...
	<div class="<?= $activeColor; ?>" <?=super_bootstrap_tooltip('Порядок');?>>
		<input class="form-control form-control-sm mysqleditor"
		       type="text"
		       value="<?= $subMenuItem['headmenu_order']; ?>"
		       data-action="edit"
		       data-table="<?= CAOP_HEADMENU; ?>"
		       data-assoc="0"
		       data-fieldid="headmenu_id"
	...
	<div class="<?= $activeColor; ?>" <?=super_bootstrap_tooltip('Доступы (отображение)');?>>
		<input class="form-control form-control-sm mysqleditor"
		       type="text"
		       value="<?= $subMenuItem['headmenu_access']; ?>"
		       data-action="edit"
		       data-table="<?= CAOP_HEADMENU; ?>"
		       data-assoc="0"
		       data-fieldid="headmenu_id"
	...
	<div class="<?= $activeColor; ?>" <?=super_bootstrap_tooltip('Включено (отображение общее)');?>>
		<input class="form-control form-control-sm mysqleditor"
		       type="text"
		       value="<?= $subMenuItem['headmenu_enabled']; ?>"
		       data-action="edit"
		       data-table="<?= CAOP_HEADMENU; ?>"
		       data-assoc="0"
		       data-fieldid="headmenu_id"
	...
	<div class="<?= $activeColor; ?>" <?=super_bootstrap_tooltip('Жирный заголовок? (1/0)');?>>
		<input class="form-control form-control-sm mysqleditor"
		       type="text"
		       value="<?= $subMenuItem['headmenu_header']; ?>"
		       data-action="edit"
		       data-table="<?= CAOP_HEADMENU; ?>"
		       data-assoc="0"
		       data-fieldid="headmenu_id"
	...
	<div class="<?= $activeColor; ?>"  <?=super_bootstrap_tooltip('Разделитель ДО');?>>
		<input class="form-control form-control-sm mysqleditor"
		       type="text"
		       value="<?= $subMenuItem['headmenu_divider_before']; ?>"
		       data-action="edit"
		       data-table="<?= CAOP_HEADMENU; ?>"
		       data-assoc="0"
		       data-fieldid="headmenu_id"
	...
	<div class="<?= $activeColor; ?>" <?=super_bootstrap_tooltip('Разделитель ПОСЛЕ');?>>
		<input class="form-control form-control-sm mysqleditor"
		       type="text"
		       value="<?= $subMenuItem['headmenu_divider_after']; ?>"
		       data-action="edit"
		       data-table="<?= CAOP_HEADMENU; ?>"
		       data-assoc="0"
		       data-fieldid="headmenu_id"
	...
	<div class="<?= $activeColor; ?>" <?=super_bootstrap_tooltip('В новой вкладке');?>>
		<input class="form-control form-control-sm mysqleditor"
		       type="text"
		       value="<?= $subMenuItem['header_blank']; ?>"
		       data-action="edit"
		       data-table="<?= CAOP_HEADMENU; ?>"
		       data-assoc="0"
		       data-fieldid="headmenu_id"
	...
	<div class="align-center <?= $activeColor; ?>">
		<button class="btn btn-info btn-sm button-menu-delete"
		        type="button"
                data-menuid="<?= $subMenuItem['headmenu_id']; ?>"
