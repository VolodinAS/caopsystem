			...
			foreach ($AllPatients as $Patient)
			{
				...
				$response['htmlData'] .= '<tr class="highlighter">
					...
					<td class="align-center">
						<button class="btn btn-success btn-sm btn-grantedPatient" data-patidid="'.$Patient['patid_id'].'" data-patidname="'.mb_ucwords($Patient['patid_name']).'" data-patidbirth="'.$Patient['patid_birth'].'">
							Назначить
						</button>
					</td>
				</tr>';
